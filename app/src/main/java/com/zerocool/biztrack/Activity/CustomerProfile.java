...
//        final ModelRetrieve modelRetrieve = Retrieve.ProfileDetails(CustomerID);
        ...
        TotalShopped1.setText(""+modelRetrieve.getTotalShopped()+Suffix);
        CashPaid1.setText(""+modelRetrieve.getCashPaid()+Suffix);
        ...
        PreviousDue.setText("" +modelRetrieve.getCustomerDue()+Suffix);
...
//                        saveCash(Phone);
        ...
        History.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                Intent intent1 = new Intent(CustomerProfile.this, CustomerHistory.class);
    ...
    private void saveCash(final String UIID) {
        ...
        SaveCash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PreviousDue.setText("" + NewDue+Suffix);
                TotalShopped1.setText(""+(modelRetrieve.getTotalShopped() + toInteger(TotalShopped))+Suffix);
                CashPaid1.setText(""+(modelRetrieve.getCashPaid() + toInteger(CashPaid))+Suffix);
...
//                ModelRetrieve modelRetrieve = Retrieve.getCustomerPaymentHistory(phone);
                ...
                if (modelRetrieve.getCustomerDue() > 0) {//this customer has previous due
                    ...
                    update.CustomerDue(modelUpdate);
                    PreviousDue.setText(""+NewRecievable+Suffix);
                    TotalShopped1.setText(""+NewTotalShopped+Suffix);
                    CashPaid1.setText(""+(modelRetrieve.getCashPaid() + 0)+Suffix);
