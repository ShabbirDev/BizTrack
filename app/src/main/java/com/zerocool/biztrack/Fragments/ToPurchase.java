...
public class ToPurchase extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.topurchase_layout, container, false);
        return rootView;
    }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        ToPurchaseAdapter adapter = new ToPurchaseAdapter(getActivity(),input);
